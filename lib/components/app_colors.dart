...
class AppColors {
  static const Color paleGreen = Color.fromRGBO(137, 204, 205, 0.21); // F3FDE8
  static const Color lightGreen = Color.fromRGBO(156, 219, 166, 1.0); // 9CDBA6
  static const Color mediumGreen =
      Color.fromRGBO(222, 249, 196, 0.81); // DEF9C4
  ...
  static const Color veryLightPink =
      Color.fromRGBO(255, 246, 246, 1.0); // FFF6F6
